  ...
  useEffect(() => {
    setTimeout(() => {
      const dummyData = {
        ...
        mbti: "ENFJ",
        personality: "소소한 농담을 던지곤 하지만 진지한 얘기도 부담 없이 잘 들어줘요 상대가 힘들 땐 먼저 알아차리려고 해요",
        hobby: "음악 플레이리스트 만들면서 감정 정리하는 걸 좋아해요 주말마다 친구랑 풋살하거나 배드민턴 쳐요 밖에서 사람들과 어울리며 즐기는 것도 좋고요",
        holiday: "늦잠 자고 여유 있게 시작해요 혼자 영화관에 가는 날도 많아요 유튜브 보면서 하루 종일 뒹굴기도 해요 자주 듣는 얘기기도 해요.",
        datingStyle: "드라이브하면서 음악 듣는 게 좋더라고요 가끔 즉흥여행도 즐기는 편이에요 데이트할 땐 상대 컨디션 먼저 살펴요 그래서 사람들과 잘 어울려요.",
        strength: "상대방 말에 공감 잘 해주는 스타일이에요 혼자 판단하기보단 꼭 상의하는 편이에요 안부 연락은 자주 하려고 해요 자주 듣는 얘기기도 해요."
      };
